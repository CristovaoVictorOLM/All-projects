...
nos seguintes
intervalos de valores: $200 - $299 |$300 - $399| $400 - $499| $500 - $599 |$600 - $699 |$700 - $799 $800| - $899 $900 |- $999 $1000
em diante Desafio: Crie ma fórmula para chegar na posição da lista a partir do salário, sem fazer vários ifs aninhados.'''


salarios =[]
contagemfaixa = [0] * 9

nvendedores = int(input('Quantos vendedores a loja tem? '))
for vendedor in range(1,nvendedores+1):
...
for Salario in salarios:
    ...
    indice = int(indice)
    indicemax = len(contagemfaixa) - 1
    indice = min(indice, indicemax)
    contagemfaixa[indice]+=1
print(contagemfaixa)
print("====================================")
print(salarios)